...
function Login() {
    ...
    const handleChange = (e) => {
        ...
        setFromLogin({ ...formLogin, [name]: value })
    }
                ...
                <div className="d-flex" style={{ width: "30rem" }}>
                    <div className="card-body z-3 p-4">
                        <form onSubmit={handleLogin}>
                            ...
                            <div className="mb-3">
                                <FormInput htmlFor={'email'} type={'email'} onChange={handleChange} title={'Email address'} />
                            ...
                            <div className="d-flex mt-4 gap-2 float-end">
